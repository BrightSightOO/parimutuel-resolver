...
use crate::generated::types::CreateResolverArgs;
...
impl CreateResolver {
    pub fn instruction(
        &self,
        args: CreateResolverInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = CreateResolverInstructionData::new().try_to_vec().unwrap();
...
impl CreateResolverInstructionData {
    fn new() -> Self {
...
pub struct CreateResolverInstructionArgs {
    pub create_resolver_args: CreateResolverArgs,
}

/// Instruction builder for `CreateResolver`.
///
/// ### Accounts:
///
///   0. `[writable]` resolver
...
#[derive(Default)]
pub struct CreateResolverBuilder {
    ...
    create_resolver_args: Option<CreateResolverArgs>,
    __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl CreateResolverBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Resolver
    ...
    #[inline(always)]
    pub fn create_resolver_args(&mut self, create_resolver_args: CreateResolverArgs) -> &mut Self {
        self.create_resolver_args = Some(create_resolver_args);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = CreateResolverInstructionArgs {
            create_resolver_args: self
                .create_resolver_args
                .clone()
                .expect("create_resolver_args is not set"),
        };
...
/// `create_resolver` CPI accounts.
pub struct CreateResolverCpiAccounts<'a, 'b> {
    /// Resolver
...
/// `create_resolver` CPI instruction.
pub struct CreateResolverCpi<'a, 'b> {
    ...
    pub __args: CreateResolverInstructionArgs,
}

impl<'a, 'b> CreateResolverCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: CreateResolverCpiAccounts<'a, 'b>,
        args: CreateResolverInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CreateResolver` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` resolver
...
///   3. `[writable, signer]` payer
///   4. `[]` system_program
pub struct CreateResolverCpiBuilder<'a, 'b> {
    instruction: Box<CreateResolverCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CreateResolverCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CreateResolverCpiBuilderInstruction {
            __program: program,
            resolver: None,
            market: None,
            request: None,
    ...
    #[inline(always)]
    pub fn create_resolver_args(&mut self, create_resolver_args: CreateResolverArgs) -> &mut Self {
        self.instruction.create_resolver_args = Some(create_resolver_args);
        self
    }
    ...
    pub fn invoke_signed(
        ...
        let instruction = CreateResolverCpi {
...
struct CreateResolverCpiBuilderInstruction<'a, 'b> {
